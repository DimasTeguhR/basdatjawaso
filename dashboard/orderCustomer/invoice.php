        ...
        <div class="col-md-12">
          <div class="tile">
            <section class="invoice" id="print">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><i class="fa fa-globe"></i> JAWASO</h2>
                </div>
                <div class="col-6">
              ...
              <div class="row invoice-info">
                <div class="col-4">From
                  <address><strong>JAWASO</strong><br>Address: Bumiayu<br>Phone: 012345678910<br>Email: Jawaso@gmail.com</address>
                </div>
                <div class="col-4">To
                  <address><strong><?php echo $name_customer ?></strong><br>Address: <?php echo $address_customer ?><br>Phone: <?php echo $phone_customer ?><br>Email: <?php echo $name_customer ?>@gmail.com</address>
                </div>
              ...
              <div class="row">
                ...
                <tbody>
                    ...
                    <td>Rp. <?php echo $ddata['price'] ;?></td>
                    <td><?php echo $ddata['quantity'] ;?></td>
                    <td>Rp. <?php echo $ddata['price'] * $ddata['quantity'] ;?></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                  </table>
